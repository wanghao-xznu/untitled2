...
Setting_2 *g_setting_2=NULL;

extern QString arr_setting[5][6];

void Setting_2::load_cfg()
{
    QFile file("bilang_2.cfg");
...
void Setting_2::on_pushButton_clicked()//only save
{
...
void Setting_2::on_pushButton_7_clicked()//2
{
    flag_num = 'M';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_8_clicked()//3
{
    flag_num = 'S';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_17_clicked()//4
{
    flag_num = 'P';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_18_clicked()//5
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_19_clicked()//6
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_3_clicked()//7
{
    flag_num = 'T';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_9_clicked()//8
{
    flag_num = 'M';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_10_clicked()//9
{
    flag_num = 'S';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_20_clicked()//10
{
    flag_num = 'P';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_24_clicked()//11
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_25_clicked()//12
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_4_clicked()//13
{
    flag_num = 'T';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_11_clicked()//14
{
    flag_num = 'M';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_12_clicked()//15
{
    flag_num = 'S';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_21_clicked()//16
{
    flag_num = 'P';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_26_clicked()//17
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_27_clicked()//18
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_5_clicked()//19
{
    flag_num = 'T';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_13_clicked()//20
{
    flag_num = 'M';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_14_clicked()//21
{
    flag_num = 'S';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_22_clicked()//22
{
    flag_num = 'P';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_28_clicked()//23
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_29_clicked()//24
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_6_clicked()//25
{
    flag_num = 'T';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_15_clicked()//26
{
    flag_num = 'M';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_16_clicked()//27
{
    flag_num = 'S';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_23_clicked()//28
{
    flag_num = 'P';
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
...
void Setting_2::on_pushButton_30_clicked()
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_31_clicked()
{
    NumKeyBoard numkeyboard;
    //numkeyboard.show();
    //numkeyboard.exec();
...
void Setting_2::on_pushButton_33_clicked() //back
{
    if(g_setting==NULL)
    {
