...
Running_4 *g_running_4=NULL;


extern QString arr_setting[5][6];
void Running_4::Page_init()
{
...
Running_4::Running_4(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Running_4)
{
...
void Running_4::close_serial()//close
{
    ::close(m_fd);
}
bool Running_4::send_serial(QString str)
{
 ...
 void Running_4::remoteDataIncoming_serial()
 {
     char c;
...
void Running_4::on_pushButton_4_clicked()//返回按钮
{
    duanwei=1;
    timer->stop();
    send_serial("STP");
...
void Running_4::on_pushButton_clicked()//开始运行button
{
    //启动定时器
...
void Running_4::on_pushButton_2_clicked()//暂停运行button
{
    //停止定时器
    timer->stop();
    send_serial("STP");
...
void Running_4::on_pushButton_3_clicked()
{
    //终止
    timer->stop();
    qDebug()<<"STOP";
